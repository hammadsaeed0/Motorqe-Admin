...
const SingleEmailList = () => {
  ...
  useEffect(() => {
    useApi.get("api/admin/email/single-sent-email").then((response) => {
      setApiData(response);
  ...
  return (
    <>
      <Head title="Single User Email List" />
      <Content>
...
export default SingleEmailList;
